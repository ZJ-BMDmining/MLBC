# MLBC: Multi-modal learning based diagnosis of neurodegenerative disorder by integrating whole-blood RNA sequencing and neuroimage data with biophysical constraints

MLBC aims to provide a structure-informed learning scheme for the diagnosis of AD and related dementia. Under the framework of multimodal Transformer, gene networks were inferred as structural constraints in neural network learning. Please refer to our [MLBC](https://ieeexplore.ieee.org/document/11357059) for more details.
